import { Table, Column, Model, CreatedAt, UpdatedAt, PrimaryKey, Unique, AutoIncrement, HasMany, BelongsToMany, DataType, ForeignKey, BelongsTo, Scopes, DefaultScope } from 'sequelize-typescript';
