import { Table, Column, Model, CreatedAt, UpdatedAt, PrimaryKey, ForeignKey, BelongsTo, HasMany, BelongsToMany, Unique, DataType, AutoIncrement } from 'sequelize-typescript';
